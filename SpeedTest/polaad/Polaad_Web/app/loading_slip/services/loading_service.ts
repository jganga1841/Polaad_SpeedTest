...
/*[GJ]@20170307 : Get the the Loading Status Reasons*/
    ...
    isLoadingQuotaConfirmed():Observable<boolean>{
     ...
     getProductStockList(loadingSlipTO : LoadingSlipTO, proCategoryID : number, prodSpecId : number):Observable<LoadingSlipExtTO[]>{
    ...
    getVehicleNoList():Observable<VehicleTO[]>{
