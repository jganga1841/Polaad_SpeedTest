...
var StockDetailsComponent = (function () {
            ...
            if (res) {
                ...
                _this.stockServices.postStockSummaryDetails(_this.stockSummaryList, _this.userTo.IdUser)
                    ...
                    if (_this.resultMessage.Result == 1) {
                        ...
                        _this.groupedStockList = {};
                        _this.getStockSummaryList();
                        _this.IsLoadingQuotaDeclaredForTheDate();
                    }
                    else
    ...
    StockDetailsComponent.prototype.IsLoadingQuotaDeclaredForTheDate = function () {
        var _this = this;
        debugger;
        this.stockServices.IsLoadingQuotaDeclaredForTheDate().subscribe(function (isConfirmed) {
