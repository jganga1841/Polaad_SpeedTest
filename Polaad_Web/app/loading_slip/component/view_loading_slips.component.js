...
var ViewLoadingComponent = (function () {
    ...
    ViewLoadingComponent.prototype.PrintLoadingSlipDetails = function (loadingTo) {
        debugger;
        this.getLoadingSlip(loadingTo.IdLoading);
    };
    ViewLoadingComponent.prototype.getLoadingSlip = function (idLoading) {
        var _this = this;
    ...
    ViewLoadingComponent.prototype.PrintReport = function () {
        if (this.isView) {
            debugger;
    ...
    ViewLoadingComponent.prototype.ngAfterViewChecked = function () {
        if (this.isView) {
            this.PrintReport();
        }
    };
