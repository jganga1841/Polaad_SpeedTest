...
var parity_component_1 = require("app/Masters/component/parity.component");
exports.routeConfig = [
    ...
    { path: 'Parity', component: parity_component_1.parityComponent, canActivate: [auth_guard_1.AuthGuard] },
];
