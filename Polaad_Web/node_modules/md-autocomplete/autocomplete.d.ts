...
export declare const MD_AUTOCOMPLETE_CONTROL_VALUE_ACCESSOR: any;
export declare class MdAutocomplete implements AfterContentInit, ControlValueAccessor {
    private element;
...
export declare const MD_AUTOCOMPLETE_DIRECTIVES: (typeof MdAutocomplete | typeof HightlightPipe)[];
