...
var BookingComponent = (function () {
    function BookingComponent(commonServices, agentServices, quotaDeclareservices, bookingServices, _confirmService) {
    ...
    BookingComponent.prototype.showConfirmDialog = function () {
        var _this = this;
        this._confirmService.activate("Do You want to book the Order?", "Confirm Dialog")
            .then(function (res) {
            if (res) {
                _this.bookingOrder();
            }
